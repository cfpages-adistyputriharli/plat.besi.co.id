---
article_id: PLT-04-05
title: "Cacat Permukaan pada Plat Hitam: Mana yang Perlu Diperiksa?"
slug: "cacat-permukaan-plat-hitam"
description: "Provide observation vocabulary, documentation steps, and escalation triggers without diagnosing from a photo alone"
status: outline
publication_date: "2025-09-10"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PLT-04
primary_intent: "Triage visible surface conditions before fabrication"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/cacat-permukaan-plat-hitam.html"
...
# Cacat Permukaan pada Plat Hitam: Mana yang Perlu Diperiksa?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cacat Permukaan pada Plat Hitam: Mana yang Perlu Diperiksa?”
- **Reader and situation:** Receiver or fabricator seeing rust, scale, pits, dents, or laminations
- **Reader outcome:** Provide observation vocabulary, documentation steps, and escalation triggers without diagnosing from a photo alone
- **Primary intent:** Triage visible surface conditions before fabrication
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not accept, reject, or repair material; PLT-14-03 owns disposition and PLT-13-02 owns surface preparation
- **Final public route:** `/artikel/cacat-permukaan-plat-hitam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cacat Permukaan pada Plat Hitam: Mana yang Perlu Diperiksa?**.
...
- **Exact Markdown to insert:** `![Ilustrasi Plat Hitam](/wp-content/uploads/2024/07/Plat-Hitam.jpg)`
...
- `PLT-04-04` → `/artikel/memilih-ketebalan-plat-hitam.html` — Memilih Ketebalan Plat Hitam: Pertanyaan yang Harus Dijawab Lebih Dulu
...
- **Tie back to this article:** Keep the explanation specific to “Cacat Permukaan pada Plat Hitam: Mana yang Perlu Diperiksa?”.
