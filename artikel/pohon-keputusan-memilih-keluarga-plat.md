---
article_id: PLT-01-06
title: "Pohon Keputusan Memilih Keluarga Plat untuk Sebuah Kebutuhan"
slug: "pohon-keputusan-memilih-keluarga-plat"
description: "Ask service-condition questions and route readers to hitam, bordes, kapal, lubang, strip, or an out-of-scope alternative"
status: outline
publication_date: "2025-06-30"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: PLT-01
primary_intent: "Route a use case to the appropriate plate family"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/pohon-keputusan-memilih-keluarga-plat.html"
...
# Pohon Keputusan Memilih Keluarga Plat untuk Sebuah Kebutuhan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pohon Keputusan Memilih Keluarga Plat untuk Sebuah Kebutuhan”
- **Reader and situation:** Buyer who knows the function but not the product name
- **Reader outcome:** Ask service-condition questions and route readers to hitam, bordes, kapal, lubang, strip, or an out-of-scope alternative
- **Primary intent:** Route a use case to the appropriate plate family
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not make structural or marine approval; PLT-09-01 owns requirements and PLT-06-02 owns marine evidence
- **Final public route:** `/artikel/pohon-keputusan-memilih-keluarga-plat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pohon Keputusan Memilih Keluarga Plat untuk Sebuah Kebutuhan**.
...
- **Tie back to this article:** Keep the explanation specific to “Pohon Keputusan Memilih Keluarga Plat untuk Sebuah Kebutuhan”.
